...
class PositionAdjuster:
    def __init__( self, base_width : int, base_height : int, base_width_pos : int, base_height_pos : int ) -> None:
...
class BaseScreen(Screen):
    def __init__( self, sd : SymulationData, pos_adj : PositionAdjuster, **kw ) -> None:
        self.sd : SymulationData = sd
        self.pos_adj : PositionAdjuster = pos_adj
        super().__init__(**kw)
    
    def resize_window( self, new_width : int, new_height : int ) -> None:
...
class PopupKivy(FloatLayout):
    ...
    def __init__( self, title : str, label_text : str, **kwargs ) -> None:
